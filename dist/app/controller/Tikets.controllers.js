    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            function contarTicketsCerrados(tickets, estado) {
                const ticketsCerrados = tickets.filter((ticket) => ticket.Estado === estado);
                return ticketsCerrados.length;
            }
            const { Fecha } = (0, DateFecha_1.FechaActually)();
            const Empresas = yield Empresa_1.default.findAll({
                attributes: ["nombre"],
                include: [{ model: Sucursales_1.default, attributes: ["nombre", "id"] }],
            });
...
function CreateTickets(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const TicketCreate = yield Ticket_1.default.create(Object.assign(Object.assign({}, Dats), { UsuarioId: UserId, Estado: "Abierto", Fecha,
                Hora }));
